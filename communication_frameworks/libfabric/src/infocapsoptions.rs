...
pub struct InfoCaps<
    ...
    const ATOMIC: bool,
    const MCAST: bool,
    const NAMEDRXCTX: bool,
    const DRECV: bool,
    const VMSG: bool,
    const HMEM: bool,
    const COLL: bool,
    const XPU: bool,
    const AV_USER_ID: bool,
    const SEND: bool,
    const RECV: bool,
    const WRITE: bool,
    const READ: bool,
...
pub const IS_AV_USER_ID: IsAvUserId = IsAvUserId::get();
    ...
    >
{
    ...
    fn add(self, _rhs: IsAvUserId) -> Self::Output {
        InfoCaps::<
            MSG,
            RMA,
            TAG,
