...
dnl
dnl Generated by mpiuser at Tue Jun 23 17:19:25 2026
dnl on rhc-node01.
dnl ---------------------------------------------------------------------------

m4_define([PRTE_PMIX_MIN_VERSION], [4.2.4])
m4_define([PRTE_PMIX_NUMERIC_MIN_VERSION], [0x00040204])
m4_define([PRTE_PMIX_MAX_VERSION], [6.0.0])
m4_define([PRTE_PMIX_NUMERIC_MAX_VERSION], [0x00060000])
...
m4_define([mca_prte_common_m4_config_component_list], [])
...
m4_define([mca_prte_ess_m4_config_component_list], [lsf, slurm, tm])
...
m4_define([mca_prte_odls_m4_config_component_list], [default])
...
m4_define([mca_prte_plm_m4_config_component_list], [lsf, slurm, ssh, tm])
...
m4_define([mca_prte_ras_m4_config_component_list], [gridengine, lsf, pbs, slurm])
m4_define([mca_prte_ras_no_config_component_list], [simulator, testrm])

dnl Components in the prte / rmaps framework
m4_define([mca_prte_rmaps_m4_config_component_list], [lsf])
...
m4_include([src/mca/rmaps/lsf/configure.m4])
